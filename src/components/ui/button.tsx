    ...
    variants: {
      variant: {
        ...
        outline:
          "btn-frosted-ghost",
        secondary:
          "btn-frosted-secondary",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-gradient-to-r from-primary to-primary-glow text-primary-foreground hover:shadow-xl transform hover:scale-105 font-bold tracking-wide",
        success: "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-lg transform hover:scale-105",
