...
import CourseViewer from "@/features/learning/components/course-viewer";
import { amazonFBACourse, aiAutomationCourse, consultingCourse } from "@/features/learning/data/amazon-fba-course";
