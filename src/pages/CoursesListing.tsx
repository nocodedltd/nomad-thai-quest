...
const courses = [
  ...
  },
  {
    ...
    description: "Start an e-commerce store without inventory. Master product selection, store setup, and customer acquisition.",
    category: "Business", 
    difficulty: "Beginner",
    duration: "3 hours",
    lessons: 4,
    ...
    features: ["Store Setup", "Product Finding", "Marketing", "Customer Service"]
  },
  {
    id: "visa-guide",
