...
const lessons = [
  ...
  },
  {
    ...
    description: "Research and identify winning products for your dropshipping store",
    duration: 35,
    xpReward: 35,
    difficulty: "beginner" as const,
    completed: false,
  ...
  },
  {
    ...
    description: "Build and optimize your e-commerce store for conversions",
    duration: 45,
    xpReward: 50,
  ...
  },
  {
    ...
    description: "Drive traffic and convert visitors into paying customers",
    duration: 50,
    xpReward: 60,
    difficulty: "intermediate" as const,
    completed: false,
...
export default function DropshippingCourse() {
  ...
  const handleStartLesson = (lessonId: string) => {
    navigate(`/course/dropshipping/lesson/${lessonId}`);
  };
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                Master Dropshipping Business
              </h1>
              <p className="text-lg sm:text-xl mb-6 text-primary-foreground/90">
                Build a profitable e-commerce business without inventory. Learn to find winning products, set up your store, and scale your dropshipping empire.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-white/10 rounded-lg p-3 text-center">
                  <div className="text-xl sm:text-2xl font-bold">3h</div>
                  <div className="text-sm opacity-90">Duration</div>
                </div>
                <div className="bg-white/10 rounded-lg p-3 text-center">
                  <div className="text-xl sm:text-2xl font-bold">$0</div>
                  <div className="text-sm opacity-90">Start Cost</div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <div className="text-sm text-muted-foreground">No upfront inventory</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <div className="text-sm text-muted-foreground">Sell worldwide</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 text-center">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-sm">Set up a professional dropshipping store</span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-accent mt-0.5 flex-shrink-0" />
                  <span className="text-sm">Find profitable products to sell</span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-accent mt-0.5 flex-shrink-0" />
                  <span className="text-sm">Connect with reliable suppliers</span>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-accent mt-0.5 flex-shrink-0" />
                  <span className="text-sm">Master digital marketing for e-commerce</span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-accent mt-0.5 flex-shrink-0" />
                  <span className="text-sm">Scale your business profitably</span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-accent mt-0.5 flex-shrink-0" />
                  <span className="text-sm">Handle customer service efficiently</span>
                </div>
              </div>
            </div>
          </CardContent>
