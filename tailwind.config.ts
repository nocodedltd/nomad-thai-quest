	...
	theme: {
		...
		extend: {
			colors: {
				...
				frosted: {
					"bg-primary": "var(--frosted-bg-primary)",
					"bg-secondary": "var(--frosted-bg-secondary)",
					"bg-tertiary": "var(--frosted-bg-tertiary)",
					"bg-elevated": "var(--frosted-bg-elevated)",
					"bg-glass": "var(--frosted-bg-glass)",
					"bg-glass-elevated": "var(--frosted-bg-glass-elevated)",
					"bg-overlay": "var(--frosted-bg-overlay)",
					"text-primary": "var(--frosted-text-primary)",
					"text-secondary": "var(--frosted-text-secondary)",
					"text-tertiary": "var(--frosted-text-tertiary)",
					"text-muted": "var(--frosted-text-muted)",
					"text-disabled": "var(--frosted-text-disabled)",
					"primary": "var(--frosted-primary)",
					"primary-hover": "var(--frosted-primary-hover)",
					"primary-light": "var(--frosted-primary-light)",
					"secondary": "var(--frosted-secondary)",
					"success": "var(--frosted-success)",
					"warning": "var(--frosted-warning)",
					"destructive": "var(--frosted-destructive)",
					"border-primary": "var(--frosted-border-primary)",
					"border-secondary": "var(--frosted-border-secondary)",
					"border-focus": "var(--frosted-border-focus)",
				},
			},
			borderRadius: {
				lg: "var(--radius)",
				...
				// Frosted Glass theme border radius
				"frosted-sm": "var(--frosted-radius-sm)",
				"frosted-md": "var(--frosted-radius-md)",
				"frosted-lg": "var(--frosted-radius-lg)",
			...
			keyframes: {
				...
				"glow-pulse": {
					"0%, 100%": { boxShadow: "var(--frosted-shadow-glow)" },
					"50%": { boxShadow: "0 0 30px var(--frosted-primary-glow)" },
				},
				"bounce-gentle": {
			...
			transitionDuration: {
				...
				"frosted-fast": "var(--frosted-transition-fast)",
				"frosted-normal": "var(--frosted-transition-normal)",
				"frosted-slow": "var(--frosted-transition-slow)",
			},
			backdropBlur: {
				xs: "2px",
				sm: "4px",
				...
				lg: "16px",
				xl: "24px",
				"frosted-sm": "var(--frosted-blur-sm)",
				"frosted-md": "var(--frosted-blur-md)",
				"frosted-lg": "var(--frosted-blur-lg)",
				"frosted-xl": "var(--frosted-blur-xl)",
			},
			boxShadow: {
				...
				"frosted-sm": "var(--frosted-shadow-sm)",
				"frosted-md": "var(--frosted-shadow-md)",
				"frosted-lg": "var(--frosted-shadow-lg)",
				"frosted-xl": "var(--frosted-shadow-xl)",
				"frosted-glow": "var(--frosted-shadow-glow)",
				"frosted-glass": "var(--frosted-shadow-glass)",
			},
			backgroundImage: {
				...
				"gradient-frosted-primary": "var(--frosted-gradient-primary)",
				"gradient-frosted-secondary": "var(--frosted-gradient-secondary)",
				"gradient-frosted-success": "var(--frosted-gradient-success)",
				"gradient-frosted-warning": "var(--frosted-gradient-warning)",
				"gradient-frosted-destructive": "var(--frosted-gradient-destructive)",
				"gradient-frosted-hero": "var(--frosted-gradient-hero)",
				"gradient-frosted-glass": "var(--frosted-gradient-glass)",
			},
			fontFamily: {
				display: ["Orbitron", "monospace"],
				heading: ["Rajdhani", "sans-serif"],
				body: ["Exo 2", "sans-serif"],
				"frosted-primary": ["Inter", "sans-serif"],
				"frosted-heading": ["Poppins", "sans-serif"],
			},
		},
	},
